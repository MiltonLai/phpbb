...
$lang = array_merge($lang, array(
	...
	'FIELD_TEXT'				=> '文本编辑框',
	'FIELD_TYPE'				=> '栏目类型',
	'FIELD_TYPE_EXPLAIN'		=> '设置栏目类型后将不可修改.',
	...
	'STEP_1_EXPLAIN_CREATE'			=> '这里您可以输入新资料栏的第一个基本参数, 以便于下一步填写和设置更详细的栏目资料.',
	'STEP_1_EXPLAIN_EDIT'			=> '这里您可以更改资料栏的基本参数. 相关的选项将在第二步重新计算.',
	'STEP_1_TITLE_CREATE'			=> '添加资料栏',
	'STEP_1_TITLE_EDIT'				=> '编辑资料栏',
	'STEP_2_EXPLAIN_CREATE'			=> '这里您可以设置一些综合选项. 还可以预览新栏目, 您需要多次调试以使栏目符合自己的要求.',
