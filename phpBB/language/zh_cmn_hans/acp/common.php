...
$lang = array_merge($lang, array(
	...
	'ACP_GROUPS'					=> '群组',
    'ACP_GROUPS_FORUM_PERMISSIONS'	=> '群组版面/版主权限',
	...
	'ACP_UPDATE'					=> '更新中',
    'ACP_USERS_FORUM_PERMISSIONS'	=> '用户版面/版主权限',
	'ACP_USERS_LOGS'				=> '用户日志',
	...
	'ACP_VIEW_GLOBAL_MOD_PERMISSIONS'	=> '查看全局版主权限',
...
// PHP info
$lang = array_merge($lang, array(
	'ACP_PHP_INFO_EXPLAIN'	=> '这个页面列出了这个服务器上所安装的PHP的信息. 这包括装载的模块, 可用的变量和默认设置, 在诊断问题时这些信息可能会有用. 请注意一些主机服务商可能会因为安全因素禁止显示某些信息. 您尽可能不要泄露这些信息, 除非在技术支持中 <a href="https://www.phpbb.com/about/">官方开发团队成员</a> 需要这些信息.',
...
$lang = array_merge($lang, array(
	...
	'LOG_ACL_ADD_USER_GLOBAL_M_'		=> '<strong>添加或编辑用户的全局版主权限</strong><br />» %s',
	'LOG_ACL_ADD_GROUP_GLOBAL_M_'		=> '<strong>添加或编辑组的全局版主权限</strong><br />» %s',
	'LOG_ACL_ADD_USER_GLOBAL_A_'		=> '<strong>添加或编辑用户的管理员权限</strong><br />» %s',
	'LOG_ACL_ADD_GROUP_GLOBAL_A_'		=> '<strong>添加或编辑群组的管理员权限</strong><br />» %s',

	'LOG_ACL_ADD_ADMIN_GLOBAL_A_'		=> '<strong>添加或编辑管理员</strong><br />» %s',
	'LOG_ACL_ADD_MOD_GLOBAL_M_'			=> '<strong>添加或编辑全局版主</strong><br />» %s',
	...
	'LOG_ACL_DEL_MOD_GLOBAL_M_'			=> '<strong>删除全局版主</strong><br />» %s',
	...
	'LOG_CONFIG_VISUAL'			=> '<strong>更改可视化确认设置</strong>',

	'LOG_APPROVE_TOPIC'			=> '<strong>审核主题</strong><br />» %s',
	...
	'LOG_PM_REPORT_CLOSED'		=> '<strong>关闭消息举报</strong><br />» %s',
	'LOG_PM_REPORT_DELETED'		=> '<strong>删除消息举报</strong><br />» %s',
	'LOG_POST_APPROVED'			=> '<strong>审核通过帖子</strong><br />» %s',
	'LOG_POST_DISAPPROVED'		=> '<strong>审核拒绝帖子 “%1$s” 因为如下的原因</strong><br />» %2$s',
	...
	'LOG_TOPIC_APPROVED'		=> '<strong>审核通过主题</strong><br />» %s',
	'LOG_TOPIC_DISAPPROVED'		=> '<strong>审核拒绝主题 “%1$s” 因为如下的原因</strong><br />%2$s',
	...
	'LOG_GROUP_CREATED'		=> '<strong>创建新群组</strong><br />» %s',
	'LOG_GROUP_DEFAULTS'	=> '<strong>设置为成员默认群组</strong><br />» %s',
	'LOG_GROUP_DELETE'		=> '<strong>删除群组</strong><br />» %s',
	'LOG_GROUP_DEMOTED'		=> '<strong>组管理员降级为一般成员</strong> %1$s<br />» %2$s',
	'LOG_GROUP_PROMOTED'	=> '<strong>成员升级为组管理员</strong> %1$s<br />» %2$s',
	'LOG_GROUP_REMOVE'		=> '<strong>成员删除自群组</strong> %1$s<br />» %2$s',
	'LOG_GROUP_UPDATED'		=> '<strong>群组细节修改</strong><br />» %s',
	'LOG_MODS_ADDED'		=> '<strong>添加新的组长至群组</strong> %1$s<br />» %2$s',
	'LOG_USERS_ADDED'		=> '<strong>添加新的成员至群组</strong> %1$s<br />» %2$s',
	'LOG_USERS_APPROVED'	=> '<strong>用户被批准进入群组</strong> %1$s<br />» %2$s',
	...
	'LOG_PRUNE_USER_DEL_DEL'	=> '<strong>清理用户 删除帖子</strong><br />» %s',
	'LOG_PRUNE_USER_DEL_ANON'	=> '<strong>清理用户 保留帖子</strong><br />» %s',
