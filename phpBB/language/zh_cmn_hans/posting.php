...
$lang = array_merge($lang, array(
	...
	'BUMP_ERROR'				=> '您不能在发表后这么快就顶帖。',

	'CANNOT_DELETE_REPLIED'		=> '对不起，您只能删除尚无回复的主题。',
	...
	'POST_EDITED_MOD'			=> '这篇帖子已经被修改但是需要审核',
	'POST_GLOBAL'				=> '全局公告',
	'POST_ICON'					=> '帖子图标',
	'POST_NORMAL'				=> '普通',
	'POST_REVIEW'				=> '帖子预览',
	'POST_REVIEW_EDIT'			=> '帖子查看',
	'POST_REVIEW_EDIT_EXPLAIN'	=> '在您编辑的过程中这篇帖子已经被其他用户更改. 您可能需要查看一下新的帖子内容以便调整自己的发帖.',
	'POST_REVIEW_EXPLAIN'		=> '已有至少一篇新回复在这个主题下发表了，您或许希望重新查看您的回贴。',
