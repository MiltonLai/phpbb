...
$lang = array_merge($lang, array(
	...
	'ALREADY_REPORTED_PM'	=> '这个消息已经被举报过了.',
	'ALREADY_WARNED'		=> '此贴已经被警告过了',
	'APPROVE'				=> '审核通过',
	'APPROVE_POST'			=> '审核通过此贴',
	'APPROVE_POST_CONFIRM'	=> '您确定要审核通过此贴吗？',
	'APPROVE_POSTS'			=> '审核通过这些帖子',
	'APPROVE_POSTS_CONFIRM'	=> '您确定要审核通过这些帖子吗？',
	...
	'DELETE_POST_CONFIRM'		=> '您确定要删除这个帖子吗？',
	'DELETE_REPORT'				=> '删除举报',
	...
	'MCP_QUEUE_UNAPPROVED_POSTS_EXPLAIN'	=> '这是需要审核后才对用户可见的帖子列表',
	'MCP_QUEUE_UNAPPROVED_TOPICS'			=> '等待审核的主题',
	'MCP_QUEUE_UNAPPROVED_TOPICS_EXPLAIN'	=> '这是需要审核后才对用户可见的主题列表',
	...
	'NOTIFY_POSTER_APPROVAL'		=> '通知作者关于审核通过的信息吗?',
	'NOTIFY_POSTER_DISAPPROVAL'		=> '通知作者关于审核拒绝的信息吗?',
	...
	'PM_REPORT_TOTAL'			=> '有<strong>1</strong>个消息举报待处理.',
	'PM_REPORTS_CLOSED_SUCCESS'	=> '选中的消息已经关闭.',
	'PM_REPORTS_DELETED_SUCCESS'=> '选中的消息已经删除.',
	'PM_REPORTS_TOTAL'			=> '总共有 <strong>%d</strong> 个消息举报待处理.',
	'PM_REPORTS_ZERO_TOTAL'		=> '没有待处理的消息举报.',
	'PM_REPORT_DETAILS'			=> '消息举报明细',
	'POSTER'					=> '作者',
	'POSTS_APPROVED_SUCCESS'	=> '成功地审核通过了这些帖子',
	...
	'POST_APPROVED_SUCCESS'		=> '成功审核通过此贴',
	...
	'REPORTS_TOTAL'				=> '目前共有 <strong>%d</strong> 条举报等待审核',
	'REPORTS_ZERO_TOTAL'		=> '目前没有等待审核的举报',
	'REPORT_CLOSED'				=> '这个举报已经关闭.',
	'REPORT_CLOSED_SUCCESS'		=> '选中的这条举报已被成功关闭。',
	'REPORT_DELETED_SUCCESS'	=> '选中的这条举报已被成功删除。',
	'REPORT_DETAILS'			=> '举报细节',
	'REPORT_MESSAGE'			=> '举报这些内容',
	'REPORT_MESSAGE_EXPLAIN'	=> '使用这个表单来向论坛管理员举报选中的内容. 举报一般用于违反版面规则的情况. <strong>注意: 举报消息将使内容对于版主和管理员可见</strong>',
	'REPORT_NOTIFY'				=> '通知您',
	...
	'THIS_PM_IP'				=> '这个站內消息的IP地址',
	'THIS_POST_IP'				=> '这篇帖子的IP地址',
	'TOPICS_APPROVED_SUCCESS'	=> '成功地审核通过了这些主题',
	'TOPICS_DELETED_SUCCESS'	=> '成功地删除了这些主题',
	'TOPICS_DISAPPROVED_SUCCESS'=> '成功地拒绝了这些主题',
	...
	'TOPIC_APPROVED_SUCCESS'	=> '成功审核通过此主题',
	'TOPIC_DELETED_SUCCESS'		=> '成功删除此主题',
	'TOPIC_DISAPPROVED_SUCCESS'	=> '成功拒绝此主题',
	...
	'UNAPPROVED_POSTS_TOTAL'		=> '目前共有 <strong>%d</strong> 篇帖子等待审核',
	'UNAPPROVED_POSTS_ZERO_TOTAL'	=> '目前没有等待审核的帖子',
	'UNAPPROVED_POST_TOTAL'			=> '目前共有 <strong>1</strong> 篇帖子等待审核',
	'UNLOCK'						=> '解锁',
	'UNLOCK_POST'					=> '解锁帖子',
