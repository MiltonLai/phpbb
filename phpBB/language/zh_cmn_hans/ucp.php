...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_COPPA'					=> '您的帐号已经建立但是需要审核。更多信息请查收您的 Email。',
	...
	'ACCOUNT_INACTIVE_ADMIN'		=> '您的帐号已经建立，但是您必须等待管理员审核帐号后才能登录。您将收到一封 Email，在帐号审核通过后我们将再次通知您。',
	...
	'FOE_MESSAGE'				=> '黑名单用户发来的消息',
	'FOES_EXPLAIN'				=> '黑名单上的用户默认被忽略。这些用户的帖子将不会全部显示并且不允许对您发送站内消息。请注意这不能阻止版主和管理员的消息。',
	'FOES_UPDATED'				=> '您的黑名单已经更新',
	'FOLDER_ADDED'				=> '文件夹已经添加',
	'FOLDER_MESSAGE_STATUS'		=> '%1$d / %2$d 已存储的消息',
	...
	'FOLDER_STATUS_MSG'			=> '文件夹空间使用率 %1$d%% (%2$d / %3$d 已存储的消息)',
	'FORWARD_PM'				=> '转发消息',
	...
	'MOVE_PM_ERROR'					=> '当移动消息到新文件夹时发生错误，只有 %1$d / %2$d 的消息被移动。',
	...
	'NOT_ADDED_FRIENDS_FOES'		=> '您不能添加黑名单上的用户到您的好友列表',
	'NOT_ADDED_FRIENDS_SELF'		=> '您不能将自己添加为好友',
	'NOT_ADDED_FOES_MOD_ADMIN'		=> '您不能添加管理员和版主到黑名单',
	'NOT_ADDED_FOES_ANONYMOUS'		=> '您不能添加匿名用户到黑名单',
	'NOT_ADDED_FOES_BOTS'			=> '您不能添加搜索爬虫到黑名单',
	'NOT_ADDED_FOES_FRIENDS'		=> '您不能添加好友列表上的用户到黑名单',
	'NOT_ADDED_FOES_SELF'			=> '您不能将自己添加到黑名单',
	'NOT_AGREE'						=> '我不同意这些条款',
	'NOT_ENOUGH_SPACE_FOLDER'		=> '目标文件夹 “%s” 已经装满。请求的操作没有完成',
	'NOT_MOVED_MESSAGE'				=> '您有一条新的消息被挂起，因为您的收件夹已满',
	'NOT_MOVED_MESSAGES'			=> '您有 %d 条挂起的消息，因为您的收件夹已满',
	'NO_ACTION_MODE'				=> '没有指定操作。',
	'NO_AUTHOR'						=> '这条消息没有设置作者',
	...
	'UCP_REMIND'					=> '发送密码',
	'UCP_RESEND'					=> '发送激活邮件',
	'UCP_WELCOME'					=> '欢迎来到用户面板。这里您可以查看和更新您的资料，参数，关注版面和主题。您还可以给其他用户发送消息 (如果允许)。在继续下一步操作前请确认您已经仔细阅读了所有的公告。',
	...
	'VIEW_PM'					=> '查看消息',
	'VIEW_PM_INFO'				=> '消息信息',
	'VIEW_PM_MESSAGE'			=> '1 条消息',
	'VIEW_PM_MESSAGES'			=> '%d 条消息',
	...
	'GROUPS_EXPLAIN'	=> '群组设置使管理员更好的管理用户。您会处于一个默认的群组中。组定义将决定您对于其他用户的显示信息，例如您的用户名颜色，头像，级别等等。你可以改变您的默认组，但是这取决于管理员的设置。您也可以被放入或加入其他组。一些群组将会具有额外的权限访问更多的区域。',
	'GROUP_LEADER'		=> '组长',
	'GROUP_MEMBER'		=> '组成员',
	'GROUP_PENDING'		=> '待审核的成员',
